...
<style scoped>
.container { padding: 20px; font-family: sans-serif; max-width: 400px; margin:0 auto; border: 1px solid #ccc; border-radius: 8px; }

.field { margin-bottom: 20px; }
label { margin-right:10px; cursor:pointer;}

.result-box {background: #282c34; color:#abb2bf; padding: 15px; border-radius: 8px; font-weight: bold;}
